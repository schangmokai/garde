...
exports.add = function(req, res) {
    ...
    try{
            ...
            var sequelize = model.marques.dbo;
            if(ready){

                model.marques.create(data).then(created=>{
                    if(created != null){
                        res.redirect('/marques_vehicules/listes');
                    }else{
                        res.json({
...
exports.deletes = function(req, res) {
    model.marques.sync({force: false}).then(() => {
          //Table created
        model.marques.destroy(
...
exports.listes =  function(req, res) { 
	  model.marques.findAll().then(result => {
        res.render('pages/marques_vehicules', {todolist: result});  
      });  
};
